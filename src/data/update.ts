...
export const filterUpdateEntities = (
  ...
  (
    ...
    if (a.attributes.title === "Vioneta Agro Core") {
      return -3;
    }
    if (b.attributes.title === "Vioneta Agro Core") {
      return 3;
    }
    if (a.attributes.title === "Vioneta Agro Operating System") {
      return -2;
    }
    if (b.attributes.title === "Vioneta Agro Operating System") {
      return 2;
    }
    if (a.attributes.title === "Vioneta Agro Supervisor") {
      return -1;
    }
    if (b.attributes.title === "Vioneta Agro Supervisor") {
      return 1;
    }
