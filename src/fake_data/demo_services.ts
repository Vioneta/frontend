...
export const demoServices: HassServices = {
  homeassistant: {
    ...
    stop: { description: "Stop the Vioneta Agro service.", fields: {} },
    restart: { description: "Restart the Vioneta Agro service.", fields: {} },
    check_config: {
      description:
        "Check the Vioneta Agro configuration files for errors. Errors will be displayed in the Vioneta Agro log.",
      fields: {},
    },
    update_entity: {
