...
class HaInitPage extends LitElement {
  ...
  protected render() {
    return this.error
      ? html`
          <p>Unable to connect to Vioneta Agro.</p>
          <p class="retry-text">
          ...
          ${location.host.includes("ui.nabu.casa")
            ? html`
                <p>
                  ...
                  Vioneta Agro is not currently connected. You can ask it to
      ...
      : html`
          ...
          <div id="loading-text">
            ${this.migration
              ? html`
                  Database upgrade is in progress, Vioneta Agro will not start
