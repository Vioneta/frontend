        ...
        if (this.hass!.config.state === STATE_NOT_RUNNING) {
          showToast(this, {
            message:
              ...
              "Vioneta Agro is starting, not everything will be available until it is finished.",
            duration: -1,
            dismissable: false,
            action: {
              text:
          ...
          ({ showAlertDialog }) => {
            showAlertDialog(this, {
              ...
              text:
                ...
                "Vioneta Agro is running in safe mode, custom integrations and modules are not available. Restart Vioneta Agro to exit safe mode.",
            });
          }
        );
      }
